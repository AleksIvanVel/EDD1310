...
public class Empleado {
    ...
    public Empleado(int id, String nombre, String paterno, String materno, int horasExtra, 
    ...
    public String toString() {
        return "Empleado{" + "id=" + id + ", nombre=" + nombre + ", paterno=" + paterno + ", "
                + "materno=" + materno + ", sueldoBase=" + sueldoBase + ", horasExtra=" + horasExtra + 
